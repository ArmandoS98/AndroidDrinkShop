...
public class DrinkAdapter extends RecyclerView.Adapter<DrinkViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final DrinkViewHolder holder, final int position) {
        ...
        holder.txt_drink_price.setText(new StringBuilder("$").append(drinkList.get(position).Price).toString());
    ...
    private void showAddToCartDialog(final int position) {
        ...
        TextView txt_product_dialog = itemView.findViewById(R.id.txt_cart_producto_name);
    ...
    private void showConfirmDialog(final int position, final String number) {
        ...
        final TextView txt_product_dialog = itemView.findViewById(R.id.txt_cart_producto_name);
        final TextView txt_product_price = itemView.findViewById(R.id.txt_cart_producto_price);
        ...
        builder.setNegativeButton("CONFIRM", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try{
                    ...
                    Log.d("AESC_DATABASE", new Gson().toJson(cartItem));
